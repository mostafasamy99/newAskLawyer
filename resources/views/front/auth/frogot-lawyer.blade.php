    ...
    <div class="login-container">
        ...
        <div class="row m-0 p-0 align-items-center">
            ...
            <div class="login-form">
                ...
                <form action="{{ route('forgot_password_lawyer_check') }}" method="post">
                    @csrf
                    <div class="form-group">
                        <input type="email" name="email" class="form-control" id="email-reset" placeholder="أدخل البريد الإلكتروني">
                    </div>
                    <button class="btn btn-outline-primary w-100 bg-dark-blue more-button">ارسال</button>
                </form>
