...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-8">
            {{-- <h1 class="page-header">City Edit</h1> --}}
        </div>
        <div class="col-lg-4">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel tabbed-panel panel-info">
                ...
                <div class="panel-body">
                    @isset($city)
                        <form role="form" action="{{url(route('admin/cities/update', $city->id))}}" method="post" enctype="multipart/form-data">
                            <div class="tab-content">
                                @csrf
                                
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="color: black;">name ar <span style="color: red;">*</span></span>
                                    <input name="name_ar" type="text" class="form-control" placeholder="name ar" value="{{$city->translate('ar')?->name}}"> 
                                </div>
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="color: black;">name en <span style="color: red;">*</span></span>
                                    <input name="name_en" type="text" class="form-control" placeholder="name en" value="{{$city->translate('en')?->name}}">
                                </div>
                                <div class="form-group input-group">
