                ...
                <div class="panel-body">
                    ...
                    <div class="dataTable_wrapper">
                                        ...
                                        <tr class="odd gradeX  text-center">
                                            ...
                                            <!-- <td>
                                                <div class="ml-2 d-flex">
                                                    <img src="{{asset($city->img)}}" alt="admin image"
                                                ...
                                                <ul class="nav navbar-center navbar-top-links" style="border-radius: 15px;">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-user">
                                                            <li >
                                                                <button class="dropdown-item btn btn-danger openBackFrom" data-toggle="modal" data-target="#myModalBack" data-id="{{$city->id}}">
                                                                    back
                                                                </button>
                                                            </li>
                                                        </ul>
                        ...
                        <div style="margin-top: 20px; font-weight: 600; font-size: 16px;">
                            Showing 1 to <span id="showItems"></span> of <span>{{App\Models\City::archive()->count()}}</span> entries
                        </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form role="form" action="{{url(route('admin/cities/back'))}}" method="get">
                                        {{ csrf_field() }}
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on('click', '#load_more_button', function() {
                ...
                function load_data(_token) {
                    $.ajax({
                        url: `{{ route("admin/cities/pagination/archives")}}/${offset}/${limit}`,
                        method: "POST",
                        data: {
                            _token: _token,
                        },
        ...
        $(document).on('keyup', '.data_search', function() {
            var q = $(this).val();
            var urlPath = "{{ route('admin/cities/search/archives') }}";
